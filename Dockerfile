...
ENV D2P_VERSION "2.1.2-SNAPSHOT"
...
"' >> /opt/dump2proto/start.sh && \
 ...
 -DD2P_ALL_CUSTOMLIST_GENERATOR_INTERVAL_S=${D2P_ALL_CUSTOMLIST_GENERATOR_INTERVAL_S:-240} \
 -DD2P_ALL_IOC_GENERATOR_INTERVAL_S=${D2P_ALL_IOC_GENERATOR_INTERVAL_S:-12600} \
 -DD2P_CUSTOMLIST_GENERATOR_INTERVAL_S=${D2P_CUSTOMLIST_GENERATOR_INTERVAL_S:-200} \
 -DD2P_IOC_GENERATOR_INTERVAL_S=${D2P_IOC_GENERATOR_INTERVAL_S:-10800} \
 -DD2P_RESOLVER_CACHE_BATCH_SIZE_S=${D2P_RESOLVER_CACHE_BATCH_SIZE_S:-20} \
 -DD2P_RESOLVER_CACHE_GENERATOR_INTERVAL_S=${D2P_RESOLVER_CACHE_GENERATOR_INTERVAL_S:-900} \
